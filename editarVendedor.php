                            ...
                            <form>
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control" id="CDTAB" placeholder="Digite o código da tabela de preços padrão">
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label for="DTNASC">Data de nascimento</label>
                                        <input type="date" class="form-control" id="DTNASC" placeholder="Data">
                                    </div>
                                    <div class="form-group col-md-12">
                                    ...
                                    <div class="form-group col-md-12">
                                        <button type="button" class="btn btn-success btn btn-block">Confirmar Edição</button>
                                    </div>
                                    <div class="form-group col-md-12">
                                        <button type="button" class="btn btn-danger btn btn-block">Excluir Vendedor</button>
                                    </div>
                                </div>
                            </form>
                            <!-- FIM DO FORMULARIO -->
                            ...
                            <form>
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control" id="CDTAB" placeholder="Digite o nome do cliente" readonly>
                                    </div>
                                    <div class="form-group col-md-12">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control" id="DTNASC" placeholder="Digite o nome do vendedor" readonly>
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label for="DTNASC">Limite de crédito</label>
                                        <input type="number" class="form-control" id="DTNASC" placeholder="Digite o valor do limite de crédito" readonly>
                                    </div>
                                </div>
                            </form>
                            <!-- FIM DO FORMULARIO -->
